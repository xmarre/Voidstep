...
namespace Voidstep
{
    ...
    internal static class VoidstepProgressionService
    {
        ...
        private static VoidstepProgressionProfile _profile = VoidstepProgressionProfile.Disabled;
        ...
        internal static VoidstepProgressionProfile Profile
        {
            get
            {
        ...
        internal static bool Enabled => Profile.Enabled;
        internal static int Level(VoidstepSkillId id) => Profile.Level(id);
