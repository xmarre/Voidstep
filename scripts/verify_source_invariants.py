...
checks = {
    ...
    'time request ownership': 'OwnershipLedger<int>' in files.get('TimeControlService.cs','') and 'GetRequestedTimeSpeed(requestId, ref requestedFactor)' in files.get('TimeControlService.cs','') and 'RemoveTimeSpeedRequest(requestId)' in files.get('TimeControlService.cs',''),
    'no unverified time request removal': 'RemoveTimeSpeedRequest(RequestId);' not in files.get('TimeControlService.cs','') and 'GetRequestedTimeSpeed(AimTimeRequestId, ref requestedFactor)' in files.get('BlinkController.cs',''),
